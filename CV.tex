...
\begin{tikzpicture}[remember picture, overlay] 
    \node[anchor = north east] at ($(current page.north east)+(-2cm,-1.2cm)$) {\includegraphics[height=3cm]{GL.png}};
  \end{tikzpicture}%
  %%%% 利用tikz来定位学校Logo，这里只在第一页显示
  \begin{tikzpicture}[remember picture, overlay] 
    \node[anchor = north west] at ($(current page.north west)+(0.5cm,+1.0cm)$) {\includegraphics[height=6cm]{hhu.png}};
  \end{tikzpicture}%
\centerline{\LARGE\bfseries{戈林}} 

\centerline{\normalsize{\faPhone\ 139-2128-5676 \quad \faEnvelopeO\ \href{mailto:1206187922@qq.com}{1206187922@qq.com}}} 
...
\textbf{苏州科技大学} \hfill 2020.9 -- 2024.6\\[0.5em] % 标题和正文间加一点距离
CC98烂坑挖掘工程与技术\quad 大二 
\begin{itemize}[nosep]
    \item 相关课程：《烂坑挖掘及基础》、《高级挖坑技巧》、《烂坑数理统计》
\end{itemize}
\textbf{河海大学} \hfill 2024.9 -- 至今\\[0.5em] % 标题和正文间加一点距离
CC98烂坑挖掘工程与技术\quad 大二 
\begin{itemize}[nosep]
    \item 相关课程：《烂坑挖掘及基础》、《高级挖坑技巧》、《烂坑数理统计》
\end{itemize}
